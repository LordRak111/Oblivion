    ...
    <header class="header">
      <div class="header-container">
        <div class="logo">
          ...
          <span class="logo-text">SpaceTech</span>
        </div>
        <nav class="nav-menu">
    ...
    <footer class="footer">
      <div class="footer-container">
        <div class="footer-column">
          ...
          <p class="footer-description">Передовые космические технологии для будущего человечества</p>
        ...
        <div class="footer-column">
          <h4>Продукты</h4>
          <ul>
            <li><a href="#">Ракеты-носители</a></li>
        ...
        <div class="footer-column">
          <h4>Контакты</h4>
          <ul>
            <li><a href="#">support@spacetech.com</a></li>
            <li><a href="#">+7 (800) 123-45-67</a></li>
            <li><a href="#">Москва, ул. Космическая, 1</a></li>
          </ul>
        </div>
      </div>
      
      <div class="footer-bottom">
        <p>&copy; 2026 SpaceTech. Все права защищены.</p>
      </div>
    </footer>
